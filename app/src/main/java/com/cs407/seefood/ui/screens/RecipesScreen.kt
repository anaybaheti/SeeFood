...
fun RecipesScreen(
    ...
    val recipes by vm.current.collectAsState()
        ...
        Column(
            ...
            if (loading) {
                ...
                Box(
                    ...
                    Text(
                        text = "No recipes yet. Try scanning or adding ingredients!",
                ...
                LazyColumn(
                    ...
                    items(recipes) { recipe ->
                        RecipeCard(
                            ...
                            onCookNow = {
                                // 1) log nutrition for this recipe
                                vm.logCookedRecipe(recipe)
...
private fun RecipeCard(
    ...
    Card(
        ...
        Column(
            ...
            // Two buttons: Cook Now + Save Recipe
            Row(
                modifier = Modifier.fillMaxWidth(),
